...
## 2026-05-08 - [Contextual Empty States]
**Learning:** In TUIs, empty lists without clear messaging leave users confused about whether the app is broken, loading, or just empty. Differentiating between a truly empty state and a "no search results" state provides immediate context and clear next steps.
**Action:** Always provide context-aware empty states with clear calls-to-action (e.g., "Press 'a' to add one") instead of blank spaces, and adjust layout filler logic to prevent jumpiness.
