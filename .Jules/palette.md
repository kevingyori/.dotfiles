...
## 2024-05-21 - [Empty State Guidance]
**Learning:** In TUI applications, blank screens during empty states or no search results are confusing. Users may think the app is broken or still loading.
**Action:** Always provide contextually differentiated empty states (e.g., distinguishing between a completely empty list and no search results) with clear call-to-actions, and adjust pagination fillers to prevent layout jumping.
