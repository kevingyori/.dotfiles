...
## 2026-03-14 - [Meaningful Empty States]
**Learning:** In TUI applications, a completely empty list can be confusing, making users wonder if the app is broken or still loading.
**Action:** Always replace missing empty states with helpful guidance and call-to-actions (e.g., 'No domains managed yet. Press 'a' to add one.') to improve usability.
