...
## 2024-06-18 - [Differentiated Empty States]
**Learning:** In TUI applications, empty states are often ambiguous. When a list is empty because of a search filter versus being completely empty, users need differentiated contextual messaging to understand why there's no data and what action to take.
**Action:** Always provide context-aware empty state messages (e.g., "No items match your search" vs "No items managed yet").
