...
## 2025-01-24 - [Contextual Empty States in TUIs]
**Learning:** In TUI applications, a completely empty view can appear broken or unresponsive to users. Differentiating between an empty state caused by a search filter versus an overall empty list provides necessary clarity.
**Action:** Always implement contextual empty states in paginated/list views. Ensure the blank space filler loop accounts for the rendered message lines to prevent layout jumping and preserve exact pagination height.
