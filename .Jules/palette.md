...
## 2024-05-24 - [TUI Empty States]
**Learning:** In TUI applications, a completely blank list view can make users feel like the app is broken or unconfigured. Providing an empty state with a call-to-action (e.g., "Press 'a' to add one.") eliminates this confusion and guides the user.
**Action:** Always provide an empty state message for empty lists in TUI apps to guide user flow.
