...
**Learning:** In TUI applications, missing empty states should be replaced with helpful guidance and call-to-actions to improve usability.
**Action:** Always provide an empty state message (e.g., 'No domains managed yet. Press 'a' to add one.') when a list is empty.
