...
## 2026-03-25 - [Contextual Empty States in TUI]
...
**Action:** Replace missing empty states with helpful guidance and call-to-actions, and adjust the blank space filler loop to account for the rendered message lines (e.g., set `numRendered = 1`) to prevent layout jumping and preserve exact pagination height.
