...
## 2026-05-07 - [Differentiated Empty States]
**Learning:** In TUI applications, empty states should clarify whether the overall list is completely empty or if a search filter simply yields no results.
**Action:** Always provide contextually differentiated empty state messaging.
