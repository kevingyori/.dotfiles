...
## 2026-03-12 - [Empty States Guidance]
**Learning:** In TUI applications, missing empty states can leave users confused. Replacing blank screens with helpful guidance and call-to-actions (e.g., 'No domains managed yet. Press 'a' to add one.') improves usability and user confidence.
**Action:** Always implement helpful empty states with call-to-actions when lists or views are empty.
