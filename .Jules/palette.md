...
## 2026-03-06 - [Guiding Empty States]
**Learning:** In TUI applications, an empty view without guidance can leave users feeling stuck or confused about how to interact with the interface.
**Action:** Implement empty state guidance with clear call-to-actions (e.g., 'No domains managed yet. Press 'a' to add one.') to improve usability when collections are empty.
