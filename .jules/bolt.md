...
**Learning:** In Go Bubble Tea applications, deep slice copies in frequent loops (e.g., View or Update rendering) cause significant memory allocations and GC pressure.
