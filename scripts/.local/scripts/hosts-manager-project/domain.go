...
// Items returns a zero-allocation read-only slice reference
// ⚡ Bolt: Used for high-frequency read operations (like UI renders) to avoid O(N) memory allocation per tick
