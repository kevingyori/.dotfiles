...
// Items returns a read-only direct reference to the domains slice.
// This is zero-allocation and ideal for frequent UI renders.
...
// Use this when passing to async tea.Cmd operations.
