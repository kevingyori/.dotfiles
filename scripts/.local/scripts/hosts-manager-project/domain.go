...
// Get returns a copy of all domains (safe for async commands)
...
// Items returns a direct reference to all domains (zero-allocation, use only for read-only UI loops)
