...
// Get returns a reference to the domains slice.
// We avoid copying here because this method is called frequently
// during Bubble Tea's Update and View loops, which would cause
// O(N) memory allocations per tick.
