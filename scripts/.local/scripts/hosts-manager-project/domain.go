...
// View returns a direct reference to the domains slice.
// This is used for read-only operations like UI rendering to avoid O(N) allocations.
func (dl *DomainList) View() []Domain {
	return dl.domains
}
