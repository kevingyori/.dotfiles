...
// GetRef returns a direct reference to the domains slice.
// WARNING: Do not modify the returned slice or pass it to async Cmds!
// Useful for high-frequency read-only operations (like UI rendering).
func (dl *DomainList) GetRef() []Domain {
	return dl.domains
}
