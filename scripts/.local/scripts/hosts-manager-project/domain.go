...
// Get returns a direct reference to all domains to avoid O(N) memory allocations per render tick
func (dl *DomainList) Get() []Domain {
	return dl.domains
}

// Clone returns a deep copy of all domains for asynchronous operations
